...
| iOS bundle | `be.prilleven.mobileapp`, ascAppId `6762270908`, buildNumber `45` (v2.11.7) |
| Android pkg | `be.prilleven.mobileapp`, versionCode `49` (v2.11.7) |
...
├── index.ts                         expo entry
├── app.json                         expo config (version 2.11.7, permissions in NL)
...
### Versionering
- `app.json.expo.version` = user-facing string (huidig `2.11.7`).
- `app.json.ios.buildNumber` (`45`) + `app.json.android.versionCode` (`49`) bumpen bij elke store-release. EAS productie heeft `autoIncrement: true`.
