...
| iOS bundle | `be.prilleven.mobileapp`, ascAppId `6762270908`, buildNumber `46` (v2.11.8) |
| Android pkg | `be.prilleven.mobileapp`, versionCode `50` (v2.11.8) |
...
├── index.ts                         expo entry
├── app.json                         expo config (version 2.11.8, permissions in NL)
...
### Versionering
- `app.json.expo.version` = user-facing string (huidig `2.11.8`).
- `app.json.ios.buildNumber` (`46`) + `app.json.android.versionCode` (`50`) bumpen bij elke store-release. EAS productie heeft `autoIncrement: true`.
