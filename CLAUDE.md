...
| iOS bundle | `be.prilleven.mobileapp`, ascAppId `6762270908`, buildNumber `51` (v2.14.0) |
| Android pkg | `be.prilleven.mobileapp`, versionCode `55` (v2.14.0) |
...
├── index.ts                         expo entry
├── app.json                         expo config (version 2.14.0, permissions in NL)
