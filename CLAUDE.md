...
| iOS bundle | `be.prilleven.mobileapp`, ascAppId `6762270908`, buildNumber `40` (v2.11.2) |
| Android pkg | `be.prilleven.mobileapp`, versionCode `44` (v2.11.2) |
...
├── index.ts                         expo entry
├── app.json                         expo config (version 2.11.2, permissions in NL)
...
### Versionering
- `app.json.expo.version` = user-facing string (huidig `2.11.2`).
- `app.json.ios.buildNumber` (`40`) + `app.json.android.versionCode` (`44`) bumpen bij elke store-release. EAS productie heeft `autoIncrement: true`.
