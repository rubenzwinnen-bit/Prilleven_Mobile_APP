...
| iOS bundle | `be.prilleven.mobileapp`, ascAppId `6762270908`, buildNumber `50` (v2.13.1) |
| Android pkg | `be.prilleven.mobileapp`, versionCode `54` (v2.13.1) |
...
├── index.ts                         expo entry
├── app.json                         expo config (version 2.13.1, permissions in NL)
...
### Versionering
- `app.json.expo.version` = user-facing string (huidig `2.13.1`).
- `app.json.ios.buildNumber` (`50`) + `app.json.android.versionCode` (`54`) bumpen bij elke store-release. EAS productie heeft `autoIncrement: true`.
